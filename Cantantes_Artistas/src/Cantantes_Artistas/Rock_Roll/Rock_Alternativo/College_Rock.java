...
public class College_Rock extends Black_Metal {
    //creacion del metodo constructor
    public College_Rock(String name, int edad, String pais, String genero, String subgenero, String tiposubgeneroo) {
